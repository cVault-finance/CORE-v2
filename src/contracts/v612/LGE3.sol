...
contract cLGE is Initializable, OwnableUpgradeSafe {
    ...
    // Reentrancy lock 
    modifier lock() {
        require(lock == false, 'CORE Vault: LOCKED');
        lock = true;
    ...
    function addLiquidityAtomic() lock public {
    ...
    function addLiquidityWithTokenWithAllowance(address token, uint256 amount) public lock {
