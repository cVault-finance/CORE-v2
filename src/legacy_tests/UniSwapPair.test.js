...
const FeeApprover = artifacts.require('TransferHandler01');
...
contract('CoreToken', ([alice, john, minter, dev, burner, clean, clean2, clean3, clean4, clean5, clean6]) => {
    before(async () => {
        ...
        this.COREGlobals = await COREGlobals.new({ from: alice });
        await this.COREGlobals.initialize(this.coreWETHPair.address, this.core.address, alice, this.corevault.address, alice, alice, { from: alice });
        ...
        await this.feeapprover.initialize(this.COREGlobals.address);
